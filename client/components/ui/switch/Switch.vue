...
<template>
  ...
  >
    <SwitchThumb
      :class="
        cn(
          'pointer-events-none h-5 w-5 flex items-center justify-center rounded-full text-zinc-200 bg-white shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-6 data-[state=unchecked]:translate-x-0 dark:bg-[#222224]'
        )
      "
    >
      <slot />
